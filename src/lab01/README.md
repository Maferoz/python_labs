...
> **Описание решения:** Простенький input(), вывод результата через f-строку.
...
> **Описание решения:** Замена возможной запятой в input с помощью replace. Подсчет срзнач и сумм. Вывод через f строку.
...
> **Описание решения:** input, использование данных формул, вывод через f строку с обязательными 2-мя символами после точки.
...
> **Описание решения:** Часы считаются через деление без остатка на 60, минуты через нахождение остатка деления на 60. Вывод через f строку, 02d добавляет нули после точки, если минут меньше 10.
